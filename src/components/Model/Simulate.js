    ...
    render() {
        ...
        return (
            <div style={{ width: 80, height: 80, position: 'relative', transform: 'scaleX(-1)' }}>
                <img
                    src={red_light}
                    alt="Red traffic signal"
                    style={{ width: "20%", position: "absolute", top: -10, left: 0 }}
                />

                <img
                    src={red_light}
                    alt="Red traffic signal"
                    style={{ width: "20%", position: "absolute", top: -10, right: 0 }}
                />

                <img
                    src={green_light}
                    alt="Green traffic signal"
                    style={{
                        zIndex: 1000,
                        width: "20%",
                        position: "absolute",
                ...
                <img
                    src={red_light}
                    alt="Red traffic signal"
                    style={{ width: "20%", position: "absolute", bottom: -10, right: 0 }}
                />

                <img
                    src={red_light}
                    alt="Red traffic signal"
                    style={{ width: "20%", position: "absolute", bottom: -10, left: 0 }}
                />
